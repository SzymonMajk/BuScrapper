...
public class DownloadThread extends Thread {
	...
	private boolean checkHeaderAndResponse()
	{
		...
		{
			log4j.info("Pobrano poprawny zasób."+currentHeader);
			return true;
		}
		...
		{
			log4j.info("Konieczne ponowienie zapytania. "+currentRequest);
		...
		{
			log4j.warn("Nie obs³u¿y³em zapytania:"+currentHeader);
			return false;
		}
	}
	...
	public boolean proceedRequest(Request request)
	{
		...
		if(request != null && downloader.initDownloader(request.getHost()))
		{
			try (OutputStreamWriter to = new OutputStreamWriter(
				...
				log4j.info("Mam wykonaæ zapytanie o parametrach:"+request.getParameters());
